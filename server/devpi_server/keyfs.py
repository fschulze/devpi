...
class KeyFS:
    ...
    @overload
    def register_key(self, key: LocatedKey) -> LocatedKey: ...

    @overload
    def register_key(self, key: PatternedKey) -> PatternedKey: ...

    def register_key(self, key: LocatedKey | PatternedKey) -> LocatedKey | PatternedKey:
