...
class Transaction:
    ...
    def iter_ulidkey_values_for(self, keys: LocatedKey | PatternedKey | SearchKey, *, fill_cache: bool = True, with_deleted: bool = False) -> Iterator[tuple[ULIDKey, KeyFSTypesRO]]:
    ...
    def iter_ulidkeys_for(self, keys: LocatedKey | PatternedKey | SearchKey, *, fill_cache: bool = True, with_deleted: bool = False) -> Iterator[ULIDKey]:
        keys_checker = KeysChecker(self, keys)
