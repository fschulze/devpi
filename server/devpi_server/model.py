...
class RootModel:
    ...
    def create_user(self, username, password, **kwargs):
        userlist = cast("TypedKey[set, SetViewReadonly]", self.keyfs.USERLIST).get_mutable()
    ...
    def delete_user(self, username):
        with cast("TypedKey[set, SetViewReadonly]", self.keyfs.USERLIST).update() as userlist:
    ...
    def get_userlist(self):
        return [
            User(self, name)
            for name in cast("TypedKey[set, SetViewReadonly]", self.keyfs.USERLIST).get()
        ]
...
class User:
    ...
    def key(self) -> TypedKey[dict, DictViewReadonly]:
        return cast("PTypedKey[dict, DictViewReadonly]", self.keyfs.USER)(user=self.name)
...
class BaseStage:
    ...
    def __init__(self, xom, username, index, ixconfig, customizer_cls):
        ...
        self.key_projects = cast("PTypedKey[set[str], SetViewReadonly[str]]", self.keyfs.PROJNAMES)(
