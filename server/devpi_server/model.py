...
def register_keys(xom, keyfs):
    ...
    # type "stage" related
    project_key = keyfs.register_named_key("PROJSIMPLELINKS", "{project}/.simple", index_key, dict)
    keyfs.register_named_key("PROJVERSIONS", ".versions", project_key, set)
    version_key = keyfs.register_named_key("PROJVERSION", "{version}/.config", project_key, dict)
