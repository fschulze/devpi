...
class PatternedKey:
    __slots__ = ('_full_rex_reverse', '_keyfs', '_keys', '_rex_reverse', '_simple_pattern_key', 'key_name', 'key_type', 'parent_key', 'pattern')
    ...
    def __call__(self, *args: str, **kw: LocatedKey | ULIDKey | str) -> LocatedKey:
        ...
        parent_key: LocatedKey | ULIDKey | None = None if self.parent_key is None else self.parent_key(**kw)
        if not isinstance(given_parent_key, Absent):
