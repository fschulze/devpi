...
class BaseConnection:
    ...
    def _relpaths_ulid_serials_stmt(
        ...
        *whereclause: sa._ColumnExpressionArgument[bool],  # type: ignore[name-defined]
        ...
        parent_ulid_stmt = sa.select(
            full_relpaths_ulid_serials_cte.c.parent_ulid.label("parent_ulid")
        ).distinct()
    ...
    def _relpaths_ulid_serials_stmt_for_keys(  # noqa: PLR0912
        self,
        keys: Sequence[LocatedKey | PatternedKey | ULIDKey],
        at_serial: int,
        *,
...
class BaseStorage:
    ...
    def define_tables(
        ...
        sa.Index(
            "ix_ulid_info_keytype_name_parent_ulid_added_at_serial",
            ulid_info_table.c.keytype,
            ulid_info_table.c.name,
            ulid_info_table.c.parent_ulid,
            ulid_info_table.c.added_at_serial,
        )
