...
class TestImportExport:
    ...
    def test_modifiedpypi(self, impexp):
        ...
        with mapp.xom.keyfs.read_transaction():
            ...
            expected_keys = {
                *(stage.get_indexconfig_fields().names),
                "type",
            } - {
                "custom_data",
                "description",
    ...
    def test_version_not_set_in_imported_versiondata(self, impexp):
        ...
        with mapp1.xom.keyfs.write_transaction():
            ...
            key_versionmetadata = stage.key_versionmetadata("hello", "1.0")
            with key_versionmetadata.with_resolved_parent().update() as verdata:
                del verdata["version"]
        impexp.export()
