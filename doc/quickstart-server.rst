...
which you may inspect::
    ...
    # @reboot /usr/local/sbin/supervisord -c /home/testuser/etc/supervisor-devpi.conf
...
The first thing to do is to set a password for the ``root`` user::
    ...
    INFO  [Wtx0] setting password for user 'root'
    INFO  [Wtx0] modified user 'root': password=*******
    INFO  [Wtx0] fswriter1: committed at 1
