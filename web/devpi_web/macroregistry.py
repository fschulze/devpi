...
class MacroRegistry:
    ...
    def register(self, obj, name, renderer, attr, groups):
        ...
        self.__dict__[name] = Macro(obj, name, renderer, None, attr, self.debug)
...
def add_macro(config, obj=None, name=None, template=None, attr=None, groups=None):
    ...
    def register(template=template):
        ...
        macro_registry.register(obj, name, renderer, attr, groups)
...
def macro_config(*, name=None, template=None, attr=None, groups=None):
    def wrap(wrapped):
        settings = dict(
            name=name,
            template=template,
