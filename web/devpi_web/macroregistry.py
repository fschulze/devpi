...
class MacroRegistry:
    ...
    def register(self, obj, name, template, renderer, attr, deprecated, groups, legacy_name):
        ...
        if legacy_name is not None:
            if (legacy_macro := self.macros.get(legacy_name)) is not None and isinstance(legacy_macro, Macro):
    ...
    def __getitem__(self, name):
        ...
        if not isinstance(macro, Macro):
            ...
            if isinstance(original_macro, Macro):
                ...
                warnings.warn(
                    f"The macro {name!r} has been moved to separate {basename!r} template.",
                    DeprecationWarning, stacklevel=5)
        return macro


def add_macro(config, obj=None, name=None, template=None, attr=None, deprecated=None, groups=None, legacy_name=None):
    ...
    def register():
        ...
        macro_registry.register(obj, name, template, renderer, attr, deprecated, groups, legacy_name)
...
def macro_config(*, name=None, template=None, attr=None, deprecated=None, groups=None, legacy_name=None):
    def wrap(wrapped):
        settings = dict(
            name=name,
            template=template,
