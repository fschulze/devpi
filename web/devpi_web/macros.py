...
@macro_config(template='templates/footer_versions.pt', groups='main_footer', legacy_name='versions')
def footer_versions(request):
    return dict(
        version_infos=request.registry.get('devpi_version_info'))


@macro_config(template='templates/header_status.pt', groups='main_header', legacy_name='status')
def header_status(request):
    return dict(status_info=request.status_info)


@macro_config(template='templates/html_head_css.pt', groups='html_head', legacy_name='headcss')
...
@macro_config(template='templates/html_head_scripts.pt', groups='html_head', legacy_name='headscript')
